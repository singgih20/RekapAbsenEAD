			...
			<form action="" method="post">
				...
				<ul>
					...
					<li>
						...
						<input type="text" class="form-control"  name="kode" id="kode" required value="<?= $mhs["kode"]; ?>"> 
					</li>

					<li>
						<label for="jam">Jam Masuk: </label>
						<input type="time" class="form-control"  name="jam" id="jam" required value="<?= $mhs["jam"]; ?>">
					</li>
					<li>
						<label for="tanggal">Tanggal: </label>
						<input type="text" class="form-control"  name="tanggal" id="tanggal" required value="<?= $mhs["tanggal"];?>">
					</li>
					<li>
