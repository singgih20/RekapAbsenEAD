...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="halregister.css">
  ...
  <div class="form-group">
    <label for="kode">Kode Asisten</label>
    <input type="kode" name="kode" class="form-control" id="kode" placeholder="Kode Asisten">
  </div>
